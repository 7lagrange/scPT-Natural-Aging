...
setwd("~/github/zhanglab-code/projects/paired_seq_tag/code/machine-experiments/RNA/doublet/liver")





rds_path <- "~/github/zhanglab-code/projects/paired_seq_tag/code/machine-experiments/RNA/cell-anno/liver/data/liver_cell_anno.rds"
...
mouse$doublet <- ifelse(
  mouse$scDblFinder.class == "doublet" |
    mouse$seurat_clusters %in% c(7, 10, 11, 18),
  "doublet",
  "singlet"
)
...
mouse <- subset(mouse, subset = seurat_clusters != "17")
...
saveRDS(mouse, file = "data/liver_cell_remode_doublets.rds")
